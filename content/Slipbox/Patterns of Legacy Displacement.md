...
created: 2026-04-29
description: "Patterns for the effective modernization of legacy software systems"
tags:
  - "clippings"
---
**Reading notes**
- Kicker: organizations need to be able to continue to deliver business needs, while at the same time replacing outdated technology
- Steps to do this
	- Align on the desired outcomes of revamp, which could be 
		- [[Patterns of Legacy Displacement#1.2.1 Understand the outcomes you want to achieve|Aligning on desired outcomes]]
		- Improving business process
		- Retiring unsupported old systems
		- Imminent disruption
		- Newer technology
	- Decide how to break the problem into smaller parts
		- Generally involves finding the right [[202604280934-seams-in-software|seams]] in the business and technical architecture, to allow independent delivery of individual needs using a new solution
			- These should have minimal dependencies on each other
		- To get started, need to map the system and speak to end user
	- Delivery strategies
	- Create a incremental displacement culture
- Case study example

---
# 1 Effective modernization of legacy software systems
...
## 1.1 The Legacy Replacement Treadmill
...
==Our observations from this and many other organizations is that technology is at most only 50% of the legacy problem, ways of working, organization structure and leadership are just as important to success.==[^2]

## 1.2 Breaking the cycle
...
### 1.2.1 Understand the outcomes you want to achieve
...
#### 1.2.1.1 Reducing the cost of change
...
#### 1.2.1.2 Improving the business process
...
### 1.2.2 Decide how to break the problem into smaller parts

Broadly speaking ==this involves finding the right [seams](https://martinfowler.com/bliki/LegacySeam.html) in the current business and technical architecture==. Importantly, you have to consider how elements of the current solution map to different business capabilities. For legacy systems this usually means discovering how one large technical solution meets multiple business needs and then seeing ==if it is possible to extract individual needs for independent delivery using a new solution==. Ideally these should be deliverable with minimal dependencies on each other.
...
| --- | --- |
| [Event Storming](https://martinfowler.com/articles/patterns-legacy-displacement/event-storming.html) † | Technique used to understand business processes |
...
### 1.2.3 Successfully deliver the parts
...
### 1.2.4 Change the organization to allow this to happen on an ongoing basis
...
| --- | --- |
| [Incremental Displacement](https://martinfowler.com/articles/patterns-legacy-displacement/incremental-displacement.html) † | Create your legacy replacement in the way you need to continue once it is live. |
...
## 1.3 An example: Integration Middleware Removal
...
### 1.3.1 Understanding the outcomes
...
### 1.3.2 Breaking the problem up: the first seam and a refactoring
...
### 1.3.3 Successfully deliver the parts: building out the functionality, maintaining the contract
...
### 1.3.4 Successfully deliver the parts (cont.): transitioning into live service - using a second seam
...
### 1.3.5 Changing the organisation to allow this to happen on an ongoing basis
...
*05 March 2024:* Event Interception

*07 July 2022:* Revert to Source Published

*28 March 2022:* Transitional Architecture Initial Publication

*20 January 2022:* Divert the Flow

*19 January 2022:* Critical Aggregator

*12 January 2022:* Legacy Mimic

*27 July 2021:* Feature Parity

*21 July 2021:* Extract Product Lines

*20 July 2021:* Patterns of Legacy Displacement Published
